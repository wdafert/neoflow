...
export default function Cell({ project, role, team }) {
    ...
    const handleDelete = () => {
        startTransition(async () => {
            const projectReq = await fetch(`/api/team/project`, {
                method: "DELETE",
                cache: "no-cache",
                body: JSON.stringify({ projectId: project.id, teamId: team }),
            })
    ...
    const handleCopy = () => {
        startTransition(async () => {
            const projectReq = await fetch(`/api/team/project/copy`, {
                method: "POST",
                cache: "no-cache",
                body: JSON.stringify({ projectId: project.id, teamId: team }),
            })

...
import { AlertTriangle, Dot, Loader2Icon, MenuIcon, MoreHorizontal, Pen, PenBox, Plus } from "lucide-react";
...
export default function TableTop({ total, children, teamId, role }) {
    ...
    const handleCreate = () => {
        startTransition(async () => {
            const projectsReq = await fetch("/api/team/project", {
                cache: "no-cache",
                method: "Post",
                body: JSON.stringify({
                    teamId: teamId
    ...
    return (
        <div className="pb-7">
            <div className="mb-3 flex items-center justify-between overflow-hidden my-4">
